// ANDREA BARBIN 3°E es 9 iterazioni
...
int main(int argc, char *argv[])
{
    ...
    // CICLO FOR PER VISUALIZZARE I NUMERI INTERI POSITIVI COMPRESI NELL'INTERVALLO CHIUSO [a;b] IN ORDINE DECRESCENTE
    printf("I numeri interi positivi compresi nell'intervallo chiuso [a;b] in ordine descrescente sono:\n");
