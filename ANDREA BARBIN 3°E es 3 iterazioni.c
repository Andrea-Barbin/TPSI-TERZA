//ANDREA BARBIN 3°E es 3 iterazioni
...
int main(int argc, char *argv[])
{
   ...
   //FASE DI ELABORAZIONE DATI
    ...
    //CICLO FOR PER VISUALIZZARE I NUMERI DISPARI INTERI POSITIVI MINORI O UGUALI A N
    printf("I numeri dispari interi positivi minori o uguali dell'ultimo numero inserito sono:\n"); 
    for (int i = 1;i<=numero;i++ ){
        
        /*Utilizzo l'operatore matematico mod per vedere se il valore assunto dal contatore i e' pari o dispari. 
        Nel caso %i sia uguale a 1, grazie all'if l'algoritmo stampa i numeri dispari + e <= n in ordine crescente, 
